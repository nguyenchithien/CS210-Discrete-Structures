...
\begin{document}
    ...
    ~\\
    % - QUESTION --------------------------------------------------%
    \begin{answersheetquestion}{8c}{Find closed formula}{3}
        Find closed formula for sequence: 1, 5, 17, 53, 161
        \iftoggle{answerkey}{ \begin{answer} $a_{n} = 3 \cdot a_{n-1} + 2$ \end{answer} }{ { ~\\ \raisebox{0pt}[2cm][0pt]{  } } }
    \end{answersheetquestion}

    ~\\
    % - QUESTION --------------------------------------------------%
    \begin{answersheetquestion}{8d}{Find closed formula}{3}
        Find closed formula for sequence: 1, 4, 10, 22, 46
    ...
    \begin{answersheetquestion}{9a}{Summations}{6}
        ...
        ~\\
        Then, add each of the elements to get the result:\\
