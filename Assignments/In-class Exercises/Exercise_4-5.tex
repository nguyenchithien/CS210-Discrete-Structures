    ...
    \begin{introNOHEAD}{\ }
        ...
        \begin{center}
            \begin{tikzpicture}[arrow/.style = {thick,-stealth}]
                ...
                %\draw[arrow] (0,-2) to[bend left] (-1,-2)   to[bend left](-0.1, -1.8);
                \draw[arrow,gray] (2,  0) to [out=-50, in=50, looseness=40] (2,0.2);
                \draw[arrow,gray] (-2, 0) to [out=-135, in=-225, looseness=40] (-2,0.2);
                \draw[arrow,gray] (0,2) to [out=0, in=150, looseness=50] (-0.2,2);
                \draw[arrow,gray] (0,-2) to [out=-35, in=-180, looseness=50] (-0.2,-2);

                \draw[arrow,gray] (0,2) to (1.9,0.1);
                \draw[arrow,gray] (0,2) to (0,-1.8);
                \draw[arrow,gray] (2,0) to (0.1,-1.9);
            \end{tikzpicture}
        \end{center}
