        ...
        \begin{enumerate}
            ...
            \item[b.] ~\\
                \begin{tikzpicture}[arrow/.style = {thick,-stealth}]
                    ...
                    \solution{ \draw[arrow] (1, 1) -- (4.5, 0.5); }{}
                    \solution{ \draw[arrow] (1, 2) -- (4.5, 2.5); }{}
                    \solution{ \draw[arrow] (1, 3) -- (4.5, 3.5); }{}
