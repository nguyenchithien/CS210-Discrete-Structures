...
\begin{document}
    ...
    \begin{answersheetquestion}{1}{Draw a table of 3 coins tossed}{10}
    ...
    ~\\ \begin{answersheetquestion}{2}{How many outcomes?}{30}
        \begin{enumerate}
    ...
    ~\\
    \begin{answersheetquestion}{3}{Equation for outcomes}{10}
        $ o = $ \iftoggle{answerkey}{\begin{answer} $ n^{m} $ \end{answer} } {}
    \end{answersheetquestion}

    
    ~\\
    \begin{answersheetquestion}{4}{Jospehus game A}{10}
    ...
    ~\\
    \begin{answersheetquestion}{5}{Jospehus game B}{10}
    ...
    ~\\
    \newpage
    \begin{answersheetquestion}{6}{Game tree}{30}
        \begin{enumerate}
            \item In a systematic way, list all the different results you could record.
